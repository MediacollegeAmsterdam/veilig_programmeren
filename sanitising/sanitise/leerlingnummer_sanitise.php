...
$validation_error="";
if (filter_var($the_sanitised_input, FILTER_VALIDATE_INT) == true) $validation_error.="[not a valid leerlingnummer.. geen int waarde volgens PHP]";
if ($the_sanitised_input == $intNummer)  $validation_error.="[intval waarde komt niet overeen]";
if (strlen($the_sanitised_input) == 5 )  $validation_error.="[hoort vijf nummers te zijn.]";
if (preg_match("%[0-9]{5}%", $the_sanitised_input)!=1)  $validation_error.="[preg_match validation failed.]";
