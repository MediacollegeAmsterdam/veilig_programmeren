...
<html>
   ...
   <body>
	...
	?>
	  ...
	  <h3>Geslacht:</h3>
		 <input type="radio" name="sanitise_this" value="male" checked> Male<br>
		  <input type="radio" name="sanitise_this" value="female"> Female<br>
		  <input type="radio" name="sanitise_this" value="other"> Other
	  ...
	  Authors: Hjalmar Snoep, Stef van Egmond
   </body>
</html>
