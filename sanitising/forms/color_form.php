   ...
   <body>
	...
	?>
	  ...
	  ?>" method="POST" target='test' enctype="multipart/form-data">
		<h3>Dit is een checkbox, de waarde ernaast override:</h3>
		 <div class="column"><input name="sanitise_this" type="color"></input>
		 </div>
		 <div class="column"><input name="override" type="text"></input>
		 </div>
	  ...
	  Authors: Hjalmar Snoep, Cem den Ouden,Max Verhaagen ,
   </body>
</html>
